---
name: Bug Report
about: Report a bug in gitlab-cli
title: "[Bug] "
labels: bug
assignees: ''
---
...
- **gitlab-cli version**: (run `gitlab-cli --version`)
...
<details>
<summary><code>gitlab-cli doctor</code> output</summary>

```
(paste the output of `gitlab-cli doctor` here)
```
