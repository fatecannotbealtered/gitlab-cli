...
func referenceSchemas() map[string]referenceDataSchema {
	return map[string]referenceDataSchema{
		...
		// ── Merge request ────────────────────────────────────────────────────
		"mr":          {Shape: "object", Fields: []string{"iid", "title", "state", "source", "target", "author", "webUrl", "draft", "description", "_untrusted"}, UntrustedFields: []string{"title", "author", "description"}},
		"mr[]":        {Shape: "list", Fields: []string{"items[]", "count", "limit", "page", "total", "hasMore", "all"}, UntrustedFields: []string{"items[].title", "items[].author"}},
		"mr_note":     {Shape: "object", Fields: []string{"id", "author", "body", "created", "_untrusted"}, UntrustedFields: []string{"body", "author"}},
		...
		"job_log":       {Shape: "object", Fields: []string{"jobId", "log", "_untrusted"}, UntrustedFields: []string{"log"}},
...
var commandExamples = map[string][]string{
	...
	"mr merge":          {"gitlab-cli mr merge 7 --dry-run --compact", "gitlab-cli mr merge 7 --confirm <confirm_token> --compact"},
	...
	"job log":       {"gitlab-cli job log 999 --compact"},
	...
	"release delete": {"gitlab-cli release delete v1.0.0 --dry-run --compact", "gitlab-cli release delete v1.0.0 --confirm <confirm_token> --compact"},
	...
	"repo branch delete": {"gitlab-cli repo branch delete feature --dry-run --compact", "gitlab-cli repo branch delete feature --confirm <confirm_token> --compact"},
	...
	"repo file delete":   {"gitlab-cli repo file delete README.md --branch main --message \"rm\" --dry-run --compact", "gitlab-cli repo file delete README.md --branch main --message \"rm\" --confirm <confirm_token> --compact"},
	...
	"variable create": {"gitlab-cli variable create --key TOKEN --value s3cr3t --dry-run --compact", "gitlab-cli variable create --key TOKEN --value s3cr3t --confirm <confirm_token> --compact"},
	"variable delete": {"gitlab-cli variable delete TOKEN --dry-run --compact", "gitlab-cli variable delete TOKEN --confirm <confirm_token> --compact"},
	"variable get":    {"gitlab-cli variable get TOKEN --compact"},
	"variable list":   {"gitlab-cli variable list --compact"},
	"variable update": {"gitlab-cli variable update TOKEN --value new --dry-run --compact", "gitlab-cli variable update TOKEN --value new --confirm <confirm_token> --compact"},
}
